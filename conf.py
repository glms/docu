...
tagline = 'This is documentation page for Grapich Linux Monitoring System'

# Change this to the description of your blog
description = 'This is docu for GLMS'

# Change this to your name
author = 'Nebojsa Badnjar'

# Change this to your copyright string
copyright = "There are no copyright for documentation, are you crazy?" #'1984, ' + author

# Change this to your blog root URL (required for RSS feed)
website = 'http://docu.glms.zyx/'
